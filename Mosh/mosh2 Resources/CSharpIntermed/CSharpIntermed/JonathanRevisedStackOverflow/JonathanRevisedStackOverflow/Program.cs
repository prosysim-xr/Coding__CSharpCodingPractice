...
namespace JonathanRevisedStackOverflow
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            VotingUI StartVoting = new VotingUI();
        ...
        public class ConversationPageView
        {
            public ConversationPageView(Conversation conversation, int postNum)
            {
                ...
                Console.WriteLine($"  ^    {cp.Title}");
                Console.WriteLine($" {cp.VoteCount} ");
                Console.WriteLine("  V" + pad.PadLeft(4) + cp.Description);
                Console.WriteLine();
